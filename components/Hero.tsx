...
export function Hero() {
  return (
    <section className="relative overflow-hidden pb-20 pt-24 sm:pt-32" id="home">
      ...
      <Container>
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <h1 className="mt-4 text-5xl font-semibold tracking-tight sm:text-7xl">{site.hero.title}</h1>
            <p className="mt-6 text-lg text-gray-600 dark:text-gray-300">{site.hero.body}</p>
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a href={site.tidycal} target="_blank" rel="noreferrer" className="btn-primary">Book a call</a>
              <a href="#case-studies" className="btn-secondary">See case studies
                <svg aria-hidden className="ml-2 h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
              </a>
            </div>
            <div className="mt-10 grid max-w-xl grid-cols-2 gap-4 sm:grid-cols-4">
              {site.hero.stats.map((s) => (
                <div key={s.label} className="rounded-xl border border-gray-200 bg-white/70 p-4 text-center backdrop-blur dark:border-gray-800 dark:bg-white/5">
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-gray-200 shadow-sm dark:border-gray-800">
              <div className="relative aspect-[8/10]">
                <Image src="/images/hero-man.png" alt="Hand drawn man sketch" fill className="object-cover" priority />
              </div>
            </div>
          </div>
        </div>
