      ...
      <Container>
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            <motion.h1 variants={item} className="mt-4 text-5xl font-semibold tracking-tight sm:text-7xl">
              {site.hero.title}
            </motion.h1>
            <motion.p variants={item} className="mt-6 text-lg text-gray-600 dark:text-gray-300">
              {site.hero.body}
            </motion.p>
            <motion.div variants={item} className="mt-8 flex flex-wrap items-center gap-3">
              ...
              >
                Book a call
                <svg aria-hidden className="ml-2 h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M5 12h14" />
                  <path d="m12 5 7 7-7 7" />
                </svg>
              </a>
              <a href="#case-studies" className="btn-secondary transition-transform duration-300 hover:-translate-y-0.5">
                See case studies
                <svg aria-hidden className="ml-2 h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M5 12h14" />
                  <path d="m12 5 7 7-7 7" />
            ...
            <div className="mt-10 grid max-w-xl grid-cols-2 gap-4 sm:grid-cols-4">
              {site.hero.stats.map((s) => (
                <motion.div key={s.label} variants={item} className="h-full rounded-xl border border-gray-200 bg-white/70 p-4 text-center backdrop-blur transition-transform duration-300 hover:-translate-y-0.5 dark:border-gray-800 dark:bg-white/5">
